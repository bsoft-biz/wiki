...
\[15:42:31\] Dima Comanda: Вместо UN4 - нужное имя схемы

\[15:42:37\] Dima Comanda: Выполнять под sys

\[15:43:28\] Dima Comanda: Если имя индекса из скрипта получится &gt; 30 символов, доработать напильником
