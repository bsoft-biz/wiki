...
* Параметры с именем, начинающимся на "EDIT\_", получают значение из указанного поля ввода на указанном окне [\(см. ниже\)](file:///D:/UNA/UNA.md-130409-4.1.5.052/un4setup/sql_params.html#EDIT).
